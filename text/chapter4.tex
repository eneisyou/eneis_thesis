...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShowNode/ARShowNodeGlobal.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShowNode/HybridCLRTool.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShowNode/ARShowTool.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/NodeGlobal.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShowNode/EntryGlobal.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShowNode/EntryCode.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShowNode/AssetBundleGlobal.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShowNode/WitAI配置.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShow/ARShowGlobal.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShow/ScanQrボタン.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node0Progress.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node2Progress.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node0UI.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShow/Linkxml配置.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShow/ServerTool.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node0UIReader.png}
...
音声コマンド制御: 「Listen」ボタンと認識結果を表示するテキストボックス。

\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node0UIListen.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node0UIPoke.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node0UIRay.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node0UIGrab.png}
\caption[Node0UIGrab]{Node0UIGrab [5]．}
\label{fig:tobita_config}
\end{center}
\end{figure}

これらのインタラクションを実現するため、技術的には PointableCanvasModule システムを利用している。通常、このイベントシステムはUnityシーン内に常駐する必要があるが、本システムでは動的にロードされるNode側（ARShowNode）で定義されたイベント設定を、実行時に本体アプリ（ARShow）のシーンへ正しく引き継ぐ仕組みを実装することで、スムーズな操作性を確保している。

\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/ARShow/PointableCanvasModule.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node0SpeakTrans.png}
\caption[Node0SpeakTrans]{Node0SpeakTrans [5]．}
\label{fig:tobita_config}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node1UI.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/Node/Node2UI.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/制作者ワークフロー.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=100mm]{./figs/提案システム/閲覧者ワークフロー.png}
