...
%%%%%%%%%  表紙  %%%%%%%%%
\title{Unity アセットの動的配信と QR コードアクセスを備えた HMD 向け AR プレゼンテーションシステム}
\author{閻 永祥}
\adviser{赤嶺 有平}

\frontmatter %ページ番号をromanに変更
\etitle{An HMD-based AR Presentation System with Dynamic Unity Asset Delivery and QR Code Access}
